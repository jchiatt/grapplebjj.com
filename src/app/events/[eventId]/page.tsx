...
function isPriceStillPayWhatYouWant(
  price: (typeof upcomingEvents)[number]["price"]
): boolean {
          ...
          <aside className="space-y-6 rounded-3xl border border-white/10 bg-white/5 p-6 text-white/85 backdrop-blur">
            <div className="space-y-3">
              ...
              <div className="space-y-2 text-sm">
                ...
                <p>
                  <span className="font-medium text-white/90">Venue:</span>{" "}
                  {event.location.name}
                </p>
                {event.location.address && (
